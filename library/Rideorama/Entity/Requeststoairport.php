...
/**
 * 
 * @Table(name="requests_to_airport")
 * @Entity(repositoryClass="Rideorama\Entity\Repository\RequeststoairportRepository")
 * @author ovo
 */
class Requeststoairport extends \Rideorama\Entity\ridesEntity {
  ...
  /**
     ...
     *
     * @OneToMany(targetEntity="Requeststoairportbookmanifest",mappedBy="requests_to_airport", cascade={"persist","remove"})
     */
