...
/**
 * 
 * @Table(name="rides_from_landmark")
 * @Entity(repositoryClass="Rideorama\Entity\Repository\RidesfromlandmarkRepository")
 * @author ovo
 */
class Ridesfromlandmark extends \Rideorama\Entity\rideoramaEntity {
   ...
   /**
     ...
     * In this case it would be where at the landmark you would want to be picked up from
     */
     ...
     * This stores the destination address of the user
     */
