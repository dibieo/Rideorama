...
/**
 * 
 * @Table(name="requests_to_landmark")
 * @Entity(repositoryClass="Rideorama\Entity\Repository\RequeststolandmarkRepository")
 * @author ovo
 */
class Requeststolandmark extends \Rideorama\Entity\rideoramaEntity {
